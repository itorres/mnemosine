...
operationDiv.style.opacity = 1;
  /*
    ok.style.transitionDuration = "0s";
    ko.style.transitionDuration = "0s";
...
function vpcenter(vpc, x, y) {
  if (typeof x === 'undefined') {
    x = ((window.innerWidth / 2) - (vpc.offsetWidth / 2)) + "px";
  }
  if (typeof y === 'undefined') {
    y = ((window.innerHeight / 2) - (vpc.offsetHeight / 2)) + "px";
  }
  console.log("centering", vpc,x,y);
